...
### Changed
- **Dark-mode neutral background and border tokens darkened to match the Anta 0.2 design.** The neutral dark ramps in `tokens.css` had drifted a step lighter than the design source and are now resynced. Backgrounds: `--bg-base` `#100e11`→`#050306`, `--bg-pane` `#1d1a1e`→`#171519`, `--bg-block` `#272329`→`#1d1a1e`, `--bg-spot` `#302b31`→`#221e24`, `--bg-section` `#171519`→`#100e11`. Borders: `--border-1` `#776e77`→`#635b65`, `--border-2` `#534c57`→`#49424c`, `--border-3` `#49424c`→`#3e3941`, `--border-4` `#3e3941`→`#302b31`, `--border-5` `#272329`→`#1d1a1e`. Light mode and all tinted (brand / critical / info / success / warning) variants are unchanged.
