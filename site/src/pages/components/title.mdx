...
<div style={{ background: 'var(--bg-pane-brand)', padding: '24px 32px', borderRadius: 8 }}>
...
`leadingIcon` / `trailingIcon` props because children are the API. Drop
any inline content beside the title text.
