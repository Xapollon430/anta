...
without `!important`). The two groups below push it — square black/white marks, and a
bigger ring with a heart-shaped mark (the dot, masked — same heart as the checkbox):
