...
forbidden in this mode (TypeScript error). The icon shape comes from
the `leadingIcon` / `trailingIcon` prop, not from `iconButton`.

<Preview>
  <Button tone="brand" iconButton leadingIcon="dots-vertical" size="small" />
  <Button tone="critical" iconButton leadingIcon="trash" />
  <Button tone="brand" iconButton leadingIcon="check" size="large" />
</Preview>
...
<Preview>
  ...
  <Button tone="brand" leadingIcon="info" trailingIcon="chevron-down" label="Filter" />
</Preview>
...
<Preview>
  <Button tone="brand" label="Save" leadingIcon="check">
...
| `leadingIcon` / `trailingIcon` | `IconShape` | Icon shape names. Required when `iconButton` is set (provides the icon). |
| `iconButton` | `boolean` | Icon-only mode. Pair with `leadingIcon` / `trailingIcon`. `label` is a TypeScript error when set. |
