...
Checkboxes are unchecked, checked, or indeterminate (for partial selection in groups). The `disabled` attribute dims the box and removes it from the tab order.
