...
Three sizes: `small` (14px), `medium` (16px, default), `large` (18px).
...
tone, the unselected box border (which becomes the fill colour; `neutral` keeps a
grey border). Six named tones (`neutral` default), or pass any CSS color for a
custom tone.
