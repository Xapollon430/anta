...
```css folded
/* field box, typed text, label, placeholder */
a-input::part(field) { background: #fafafa; border-radius: 8px; }
a-input::part(input) { font-family: var(--monospace); }
a-input::part(label) { letter-spacing: 0.02em; }
```
