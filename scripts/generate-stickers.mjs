...
export async function generate({ input, output, internal = false } = {}) {
  ...
  for (const name of subdirs) {
    ...
    // exists. Imports from `@antadesign/anta/sticker-runtime` which
    // carries no dotLottie dependency. Lives at `<name>.ts` so the
    ...
    // assign it to an `<a-sticker>` element's `svg` property).
    ...
    if (hasSvg) {
      ...
      const lines = [
        ...
        "",
        "import { Sticker, type StickerProps } from '@antadesign/anta/sticker-runtime'",
        "",
    ...
    // sticker (`<name>.ts`) never drags the Lottie payload or
    // dotLottie. Bundlers tree-shake per-file when the barrel uses
    // `export { … } from './foo'`.
    //
    ...
    if (hasLottie) {
      ...
      const lines = [
        "/* Auto-generated by @antadesign/anta. Do not edit by hand. */",
        "",
        "import { StickerAnimated, type StickerAnimatedProps } from '@antadesign/anta/sticker-runtime/animated'",
        "",
  ...
  const indexLines = [
    "/* Auto-generated by @antadesign/anta. Do not edit by hand. */",
    "",
    "export type { StickerProps } from '@antadesign/anta/sticker-runtime'",
    "export type { StickerAnimatedProps } from '@antadesign/anta/sticker-runtime/animated'",
    "",
    ...reExports,
    "",
  ];
